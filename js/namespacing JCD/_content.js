    ...
    airports : {
        pudong : {
            en : {
                ...
                map : "<div class='map'>\
                <h3>You will be able to find the ticket machine at</h3>\
        ...
        hongqiao : {
            en : {
                ...
                map : "<div class='map'>\
                You will be able to find the ticket machine at T1 boarding gate B9-B10.<br>\
                </div>"
            },
            zh : {
                welcome : "虹桥机场欢迎您",
...
App.content = {
    zh : {
        ...
        login : {
            ...
            form_a : {
                ...
                2 : {
                    ...
                    switcher : "手机号登录",
                    lang_switcher : "EN",
                    interrogation : "<img src='images/hotline-white.png'/>",
                },
            },
            form_b : {
                1: {
                    ...
                    conditions : "我已阅读并接受上网协议",
                    lang_switcher : "EN",
                    interrogation : "<img src='images/hotline-black.png'/>",
                },
                2 : {
                    title: "获取登录帐户",
                    name_placeholder: "帐号",
        ...
        popup : {
            ...
            无线虹桥有权根据需要不时地制订、修改本协议及/或各类规则，并以公示的方式进行变更公告，无需另行单独通知您。当你再次使用即表示您已经阅读、理解并接受经修订的协议和规则。若您不同意相关变更，应当立即停止使用开放免费Wi-Fi服务。<br></div>",
        },
        home : {
    ...
    en : {
        ...
        splashscreen : {
            tagline : "Welcome to Pudong Airport",
        },
        login : {
            error : {
            ...
            form_a : {
                1 : {
                    ...
                    button_1: "Get Code",
                    counter_1: 60,
                    code_placeholder: "Phone Code",
                    button_2: "Log in",
                    conditions: "I have read and accept it",
                    form_switcher: "Other way to login",
                },
                2 : {
                    title : "Get your log-in account through ticket machine",
        ...
        popup : {
            ...
            This free wi-fi is provided by your current Internet environment where open free network.<br><br>\
